        ...
        {({isSubmitting, values}) => (
            <div className={cx('container')}>
              ...
              <Form className={cx('form')}>
                ...
                <div className={cx('form__field', 'field')}>
                  ...
                  <div onClick={togglePassword}>
                    <Icon typeIcon={showPassword ? 'eye-off' : 'eye-on'}
              ...
              <div className={cx("form__link, link")}>
                     <span className={cx('link__text')}>Не зарегистрирован(а)?
                         <Link to={routes.SIGNUP_PAGE} className="link__link">Регистрация</Link>
                     </span>
              </div>
            </div>
        )}
